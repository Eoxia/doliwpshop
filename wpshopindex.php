...
/**
 *	\file       htdocs/wpshop/template/wpshopindex.php
 *	\ingroup    wpshop
 *	\brief      Home page of wpshop top menu
 */
...
$langs->loadLangs(array("wpshop@wpshop"));

$action=GETPOST('action', 'alpha');

// Securite acces client
if (! $user->rights->wpshop->read) accessforbidden();
...
llxHeader("",$langs->trans("WpshopArea"));

print load_fiche_titre($langs->trans("WpshopArea"),'','wpshop.png@wpshop');
...
// Draft MyObject
if (! empty($conf->wpshop->enabled) && $user->rights->wpshop->read)
{
	$langs->load("orders");
