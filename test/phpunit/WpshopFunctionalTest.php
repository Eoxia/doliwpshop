...
/**
 * \file    test/functional/WpshopFunctionalTest.php
 * \ingroup wpshop
 ...
 * @package Testwpshop
 */
class WpshopFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/wpshop/admin/about.php');
		$this->authenticate();
		return $this->assertContains('wpshop/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('wpshopwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWpshop_WpshopTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWpshop_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
