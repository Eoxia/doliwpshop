...
print load_fiche_titre($page_name, $linkback, 'object_doliwpshop@doliwpshop');

// Configuration header
$head = doliwpshopAdminPrepareHead();
dol_fiche_head($head, 'categories', '', -1, "doliwpshop@doliwpshop");

// Setup page goes here
echo 'Configuration de la synchronisation des catégories.<br><br>';

print '<table class="noborder" width="100%">';
print '<tr class="liste_titre"><td class="titlefield">Paramètre</td><td>Valeur</td></tr>';
print '<tr class="oddevent"><td colspan="2">Aucun paramètre pour le moment.</td></tr>';
print '</table>';
