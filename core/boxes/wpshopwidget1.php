...
/**
 * \file    modulebuilder/template/core/boxes/wpshopwidget1.php
 * \ingroup wpshop
 * \brief   Widget provided by Wpshop
 *
 ...
 */
class wpshopwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "wpshopbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "wpshop@wpshop";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->wpshop->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/wpshop/class/wpshop.class.php";

		// Populate the head at runtime
		$text = $langs->trans("WpshopBoxDescription", $max);
