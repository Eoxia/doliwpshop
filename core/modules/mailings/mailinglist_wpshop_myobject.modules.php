...
dol_include_once("/wpshop/class/myobject.class.php");


/**
 * mailing_mailinglist_wpshop
 */
class mailing_mailinglist_wpshop_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_wpshop_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('wpshop',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/wpshop/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_wpshop_myobject.modules.php: mailing ".$num." targets found");
